...
/**
 * Decode &amp; &#x16a0; etc.
 * Copied from https://blogs.msdn.microsoft.com/aoakley/2003/11/12/safely-displaying-untrusted-html/
 * @param {String} s 
 */
            ...
            if (semicolonIndex > 0) {
                ...
                if (entity.length > 1 && entity.charAt(0) == '#') {
                    if (entity.charAt(1) == 'x' || entity.charAt(1) == 'X')
                        ch = String.fromCharCode(parseInt(entity.substring(1), 8));
                    else
                        ch = String.fromCharCode(parseInt(entity.substring(1)));
                } else {
                    switch (entity) {
                        case 'quot':
